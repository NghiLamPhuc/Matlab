...
%% Bai 2
% Nhap vào tháng và nam, in so ngày cua tháng.
...
%{
Muon hien thi nhieu bien cùng mot dòng, dùng '[ ]' de^? no^'i
các chuo^~i(string), cách nhau dau pha^?y.
num2str là hàm chuye^?n so^' thành string
